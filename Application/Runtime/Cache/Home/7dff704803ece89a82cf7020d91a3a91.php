...
<div class='signup_container'>
    ...
    <div id="signup_forms" class="signup_forms clearfix">
	    <form class="signup_form_form" id="ssoForm" name="ssoForm" method="post" action=""  data-secure-ajax-action="">
	 		 <?php if(is_array($sso)): foreach($sso as $key=>$vo): ?><input type='hidden' name='<?php echo ($key); ?>' value="<?php echo ($vo); ?>" /><br/><?php endforeach; endif; ?>
    ...
    <div class="login-btn-set"><a href='javascript:ssoLogin()' class='login-btn'></a></div>
    <div class="input">
...
function ssoLogin() {
	...
	$.ajax({
		type:'POST',
		url:'<?php echo U("Login/ssoLogin");?>',
		data:$('#ssoForm').serializeArray(),
		async:false,
		dataType: 'json',
		cache:false,
